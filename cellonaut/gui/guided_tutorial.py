...
TUTORIAL_STEPS = (
    ...
    TutorialStep("Enable Cellpose", "Enable a channel to create one reusable Channel_Cellpose mask column. Other measured channels can use the same cells.", "cellpose_enable", 2, "cellpose_on"),
    ...
    TutorialStep("Measurement region", "Turn ON the regions to measure. Rows are measured channels; each enabled Cellpose channel has its own reusable column.", "analysis_matrix_table", 4, "relationship"),
